...
- task management through Apple Reminders;
...
- attempt to reverse engineer, decompile, or modify the App, except where permitted by applicable law;
- interfere with the operation, security, or integrity of the App;
- use the App in a way that could damage, disable, or impair the App or related services;
- attempt to access data or systems that you are not authorized to access;
- copy, reproduce, distribute, sell, rent, sublicense, or exploit the App except as expressly permitted by these Terms.
...
- you are not located in a country or region subject to a U.S. government embargo or designated by the U.S. government as a "terrorist supporting" country;
